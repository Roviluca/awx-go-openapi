...
Optional parameters are passed through a pointer to a HostsHostsGroupsListOpts struct
...
Optional parameters are passed through a pointer to a HostsHostsJobEventsListOpts struct
